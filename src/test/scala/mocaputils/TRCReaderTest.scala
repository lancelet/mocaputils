...
class TRCReaderTest extends FunSuite {
  ...
  test("read - test file") {
	...
	val expCoords = Vector(
	  (1247.12988, 649.67725, 1446.53552),
	  (1247.26807, 650.12024, 1447.11145),
	  (1246.90698, 650.64636, 1447.61157),
	  (1246.85059, 650.76019, 1447.70544),
	  (1246.60803, 651.06555, 1447.99841)
	).map(Some(_))
	assert(s.getMarker("Head").toList === expCoords.toList)
